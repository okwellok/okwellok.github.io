...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
...
skip:!0})]}]})})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
end:/$/}]})})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
end:"\\)"}]},{className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
contains:p}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
end:/$/,keywords:{$pattern:/[\.\w]+/,keyword:".PHONY"}},r]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(e){
...
contains:[a.SHEBANG({binary:"ruby"})].concat(E).concat(c).concat(_)}}})());hljs.registerLanguage("autohotkey",(()=>{"use strict";return e=>{const a={
...
begin:"A_[a-zA-Z0-9]+"},{begin:",\\s*,"}]}}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
